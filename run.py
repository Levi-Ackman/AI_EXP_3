...
import numpy as np
import time
Model_option=['PatchTST','Crossformer']
Lr_option=[1e-4]
Batch_size_op=[128]
Optim_op=['Adam']

# seq_len_label_len_pre_len:
input_label_pres_opt=[[1024,1024,16]]
...
if __name__ == '__main__':
    ...
    # basic config
    parser.add_argument('--model', type=str, required=False, default='Crossformer',
                        help='model name, options: [PatchTST, Crossformer]')
    ...
    parser.add_argument('--data_path', type=str, default='/home/Paradise/AI_EX/Data/TaxiData.csv', help='root path of the data file')
    parser.add_argument('--json_path', type=str, default='/home/Paradise/AI_EX/Data/shenzhenshi.json', help='json file')
    parser.add_argument('--split_ratio', type=list, default=[0.7,0.2,0.1], help='data_split_ratio')
    parser.add_argument('--data_len', type=int, default=120000, help='prediction sequence length')
    ...
    parser.add_argument('--seg', type=int, default=5, help='input sequence length')
    ...
    parser.add_argument('--moving_avg', type=int, default=125, help='window size of moving average')
    ...
    parser.add_argument('--patience', type=int, default=14, help='early stopping patience')
    parser.add_argument('--learning_rate', type=float, default=1e-3, help='optimizer learning rate')
    parser.add_argument('--des', type=str, default='test', help='exp description')
    parser.add_argument('--loss', type=str, default='mae', help='loss function [mae,mse]')
                ...
                for optim in Optim_op:
                    ...
                    for batch_idx in Batch_size_op:
                        ...
                        for lr_idx in Lr_option:
                                ...
                                setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}'.format(
                                    args.model,
                                    args.data_path[:-4],
                                    args.features,
                                    args.seq_len,
